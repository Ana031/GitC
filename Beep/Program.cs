...
namespace Beep
{
...

    {
        ...
        {
            //Aqui nesta parte ele pega a hora e o minuto
            ...
            //Assinando nossa variavel de comparação
            var timeStart = Console.ReadLine();


            //Laço de repetição que fica rodando enquando não for a hora marcada
            while (dateVerify != timeStart)

            {
                //Atualizamos os valores da variavel "dateVeryfy com a hora e minutos atuais
